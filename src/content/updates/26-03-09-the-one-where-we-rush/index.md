...
tagline: "We tore our chapters apart, gave our articles a license, and extended our late Valentine's Day Sale to end March 14th. As they do."
created_at: 2026-02-26T04:38:22.744Z
tags:
  - newsletter
socials: []
---
...
![file:](./images/what-is-a-terminal.png)
...
![file:](./images/creative-common-license.png)
...
- **Welcome to the GitHub:** A warm shoutout to the **newest first-time
  contributors to our GitHub—and _for some_ GitHub itself: [Ev](/contributors/ev), [Hyena](/contributors/hyena) _(✨first ever!✨)_, PC _(✨first ever!✨)_, and [Rie](/contributors/rie) _(✨first ever!✨)_!**
